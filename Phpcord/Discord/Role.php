...
use Phpcord\Discord\Permissions\RolePermission;
 ...
 * @property Permissions\RolePermission                $permissions The permissions of the role.
...
class Role extends Model
{
    ...
    public function setPermissionsAttribute($permission)
    {
        if (! ($permission instanceof RolePermission)) {
            $permissionPart = new RolePermission();
